...
class AlterAllFkTables extends Migration
{
    ...
    public function up()
    {
        Schema::table('passwords_usuario', function ($table) {
            $table->foreign('usuario_id')->references('id_usuario')->on('usuarios')->onDelete('cascade');
        });
        Schema::table('imagenes_usuario', function ($table) {
            $table->foreign('usuario_id')->references('id_usuario')->on('usuarios')->onDelete('cascade');
        });
        ...
        Schema::table('empresas_transporte', function ($table) {
            $table->foreign('usuario_id')->references('id_usuario')->on('usuarios')->onDelete('cascade');
            $table->foreign('tipo_envio_id')->references('id_tipo_envio')->on('tipos_transporte')->onDelete('cascade');
        });
        ...
        Schema::table('pedidos', function ($table) {
            $table->foreign('usuario_id')->references('id_usuario')->on('usuarios')->onDelete('cascade');
            $table->foreign('envio_id')->references('id_envio')->on('envios')->onDelete('cascade');
            $table->foreign('cobro_id')->references('id_cobro')->on('cobros')->onDelete('cascade');
        ...
        Schema::table('usuarios', function ($table) {
            ...
            $table->foreign('password_usuario_id')->references('id_password_usuario')->on('passwords_usuario')->onDelete('cascade');
            $table->foreign('imagen_usuario_id')->references('id_imagen_usuario')->on('imagenes_usuario')->onDelete('cascade');
        });
}
    ...
    {
        Schema::table('passwords_usuario', function ($table) {
            $table->dropForeign('passwords_usuario_usuario_id_foreign');
        });
        Schema::table('imagenes_usuario', function ($table) {
            $table->dropForeign('imagenes_usuario_usuario_id_foreign');
        });
        Schema::table('imagenes_articulo', function ($table) {
        ...
        Schema::table('empresas_transporte', function ($table) {
            ...
            $table->dropForeign('empresas_transporte_tipo_envio_id_foreign');
        });
        Schema::table('envios', function ($table) {
        ...
        Schema::table('cobros', function ($table) {
            $table->dropForeign('cobros_usuario_id_foreign');
        ...
        Schema::table('pedidos', function ($table) {
            ...
            $table->dropForeign('pedidos_cobro_id_foreign');
            $table->dropForeign('pedidos_estado_pedido_id_foreign');

        });
        Schema::table('bancos', function ($table) {
            $table->dropForeign('bancos_usuario_id_foreign');
            $table->dropForeign('bancos_empresa_cobro_id_foreign');
        });
        Schema::table('tarjetas', function ($table) {
            $table->dropForeign('tarjetas_usuario_id_foreign');
            $table->dropForeign('tarjetas_empresa_cobro_id_foreign');
        });
        Schema::table('direcciones', function ($table) {
        ...
        Schema::table('usuarios', function ($table) {
            ...
            $table->dropForeign('usuarios_password_usuario_id_foreign');
            $table->dropForeign('usuarios_imagen_usuario_id_foreign');
        });
    }
}
