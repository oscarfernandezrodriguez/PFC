    ...
    @if(sizeof($comentariosUsuario)!=0)
        @foreach($comentariosUsuario as $comentarioUsuario)
            ...
            @php
                ...
                $slugCategoria=\App\Seccion::select('secciones.slug')->join('articulos','articulos.seccion_id','=','secciones.id_seccion')->where('articulos.id_articulo','=',$comentarioUsuario->articulo_id)->get();
                $slugSubcategoria=\App\Subseccion::select('subsecciones.slug')->join('articulos','articulos.subseccion_id','=','subsecciones.id_subseccion')->where('articulos.id_articulo','=',$comentarioUsuario->articulo_id)->get();
