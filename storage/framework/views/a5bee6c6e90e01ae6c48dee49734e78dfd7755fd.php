...
unset($__errorArgs, $__bag); ?>" name="nombre"
                                           value="<?php echo e(old('nombre')); ?>" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="apellido1" type="text"
                                           class="form-control <?php $__errorArgs = ['apellido1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="apellido1"
                                           value="<?php echo e(old('apellido1')); ?>" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="apellido2" type="text"
                                           class="form-control <?php $__errorArgs = ['apellido2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="apellido2"
                                           value="<?php echo e(old('apellido2')); ?>" required autocomplete="name" autofocus>
...
<?php endif; ?>
<?php /**PATH /var/www/html/PFC/resources/views/partials/autenticarse/registro.blade.php ENDPATH**/ ?>